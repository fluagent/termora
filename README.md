...
## 📥 Download Release (v0.0.45)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.45-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.45/Termora-v0.0.45-macOS.dmg)
