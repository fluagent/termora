...
## 📥 Download Release (v0.0.44)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.44-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.44/Termora-v0.0.44-macOS.dmg)
